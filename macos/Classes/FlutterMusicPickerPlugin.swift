...
///
/// On macOS, this plugin scans standard music directories to discover
/// audio files and ringtone directories for system sounds. Uses
/// [AVAsset] to estimate audio durations and [AVAudioPlayer] for
...
public class FlutterMusicPickerPlugin: NSObject, FlutterPlugin {
    ...
    ///
    /// Returns a list of maps with "id", "title", "uri", etc.
